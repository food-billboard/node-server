...
describe(`${COMMON_API} test`, function() {
  ...
  describe(`get the comment detail with self info test -> ${COMMON_API}`, function() {
    ...
    describe(`get the comment detail with self info success test -> ${COMMON_API}`, function() {
      ...
      it.skip(`get the comment detail with self info success and return the status of 304`, function(done) {
      ...
      it.skip(`get the comment detail with self info success and hope return the status of 304 but the params of query is change`, function(done) {
