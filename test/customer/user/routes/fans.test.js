...
const COMMON_API = '/api/customer/user/fans'
...
describe(`${COMMON_API} test`, function() {
  ...
  describe(`get the user fans list and not self and with self info test -> ${COMMON_API}`, function() {
    ...
    before(function(done) {
      ...
      const { model:fans } = mockCreateUser({
        username: COMMON_API,
      }) 
      ...
      .then(function([target, self, fans]) {
        userResult = self
    ...
    describe(`get the user fans list and not self and with self info success test -> ${COMMON_API}`, function() {

      it(`get the user fans list and not self and with self info success`, function(done) {
      ...
      it(`get the user fans list and not self and with self info success and self is the fans of attention`, function(done) {
    ...
    describe(`get the user fans list and not self and with self info fail test -> ${COMMON_API}`, function() {

      it(`get the user fans list and not self and with self info fail because the user id is not found`, function(done) {
      ...
      it(`get the user fans list and not self and with self info fail because the user id is not verify`, function(done) {
