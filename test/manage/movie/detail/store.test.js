...
function responseExpect(res, validate=[]) {
  ...
  target.list.forEach(item => {
    ...
    expect(item).to.be.a('object').and.that.includes.any.keys('movie_name', 'roles', 'glance_date', 'issue_count', 'status', 'username', 'mobile', 'email', 'hot', 'fans_count', 'attentions_count', 'createdAt', 'updatedAt', '_id', 'avatar')
